...
-- name: DeleteCompetitionRatingComparisonsBySportKey :execrows
DELETE FROM apollo.competition_rating_comparisons
WHERE sport_key = $1;

-- name: UpsertCompetitionOpenSkillComputedEvent :one
INSERT INTO apollo.competition_rating_events (
  event_type,
  rating_engine,
  engine_version,
...
-- name: UpsertCompetitionRatingDeltaFlaggedEvent :one
INSERT INTO apollo.competition_rating_events (
  event_type,
  rating_engine,
  engine_version,
...
-- name: UpsertCompetitionRatingComparison :one
