...
| why the profile/auth model looks the way it does | ADRs in `adr/` | [`growing-pains.md`](growing-pains.md) |
...
| `diagrams/` | standalone Mermaid source for the repo flow |
| `growing-pains.md` | engineering lessons and tradeoff history |
